...
function EditAchievementModal({ isOpen, onClose, onSave, achievement, categories }) {
  ...
  useEffect(() => {
    if (achievement) {
      ...
      if (achievement.imageUrl && achievement.imageUrl !== "undefined") {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (typeof formData.imageUrl === "string" && formData.imageUrl !== "undefined") {
        // existing image
        data.append("existingImage", formData.imageUrl);
