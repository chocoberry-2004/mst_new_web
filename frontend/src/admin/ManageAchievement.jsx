...
//     if (!achievedCountry.includes(cou.country)) {
...
//     if(!achievedCategory.includes(cat.category)) {
...
//   // console.log(countriesWithAchievements);
...
//     const normalized = {
//       ...updatedAchievement,
//       image: updatedAchievement.imageUrl || updatedAchievement.image
//     };
...
//                       e.target.src = `https://t4.ftcdn.net/jpg/06/57/37/01/360_F_657370150_pdNeG5pjI976ZasVbKN9VqH1rfoykdYU.jpg` || {placeholderImg};
//                     }}
//                   />
//                 </div>
...
//                     onError={(e) => {
//                       e.target.onerror = null;
//                       e.target.src = `https://t4.ftcdn.net/jpg/06/57/37/01/360_F_657370150_pdNeG5pjI976ZasVbKN9VqH1rfoykdYU.jpg`;
//                     }}
//                      />
//                   </td>
//                   <td className="px-6 py-4">
