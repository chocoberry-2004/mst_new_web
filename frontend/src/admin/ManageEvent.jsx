...
function ManageEvent() {
  ...
  const handleEditEvent = async () => {
    try {
      const response = await updateEvent(selectedEvent._id, selectedEvent);
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-1 space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="e.g., 15-17 Dec 2023"
                      required
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FFC53A]"
                      value={newEvent.date}
                ...
                <div className="flex items-center">
                  <label className="flex items-center gap-2 text-sm font-medium text-gray-700">
                    <input
                      type="checkbox"
                      checked={newEvent.highlight}
                      onChange={(e) => setNewEvent({...newEvent, highlight: e.target.checked})}
